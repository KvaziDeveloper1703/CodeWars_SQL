/*
Write an SQL query to process a table named love with columns flower1 and flower2, representing the number of petals on two flowers.
...
Напишите SQL-запрос для обработки таблицы love с колонками flower1 и flower2, представляющими количество лепестков на двух цветах.
